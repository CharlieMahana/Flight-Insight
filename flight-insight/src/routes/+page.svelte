<body class="bg-primary h-screen w-screen flex justify-center content-center">
  <div class="m-auto lg:w-1/2 w-10/12">
    <p class="text-base-100 text-center md:text-4xl text-2xl">American Airlines Flight Insight</p>
    <div class="card bg-base-100 p-2 justify-center content-center text-base-100 md:w-1/2 m-auto mt-10 md:h-128 h-96">
